...
const ChurmaLaddu = () => {
  ...
  const fetchCustomers = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/get_churma_laddu_forms.php`);
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = "churma_laddu_customers.csv";
    a.click();
  ...
  const exportExcel = () => {
    ...
    XLSX.writeFile(wb, "churma_laddu_customers.xlsx");
    setShowExportMenu(false);
  };
  ...
  const exportPDF = () => {
    try {
      const doc = new jsPDF();
      doc.text("Churma Laddu Customer Data", 14, 15);
      autoTable(doc, {
      ...
      doc.save("churma_laddu_customers.pdf");
    } catch (error) {
      ...
      <div className="mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          ...
          <p className="text-gray-500 text-sm">
            Manage and export customer submissions
          </p>
        </div>
